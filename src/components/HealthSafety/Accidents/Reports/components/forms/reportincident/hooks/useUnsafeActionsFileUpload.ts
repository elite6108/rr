...
import { uploadUnsafeActionsFile } from '../utils/unsafeActionsFileUtils';

export const useUnsafeActionsFileUpload = () => {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      for (const file of fileArray) {
        const signedUrl = await uploadUnsafeActionsFile(file, autoId);
