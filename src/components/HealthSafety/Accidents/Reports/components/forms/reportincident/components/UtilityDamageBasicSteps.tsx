...
interface UtilityDamageBasicStepsProps {
  formData: UtilityDamageFormData;
  setFormData: React.Dispatch<React.SetStateAction<UtilityDamageFormData>>;
  isLoadingId: boolean;
}

export const UtilityDamageDetailsStep: React.FC<UtilityDamageBasicStepsProps> = ({ formData, isLoadingId }) => (
...
export const UtilityDamageDescriptionStep: React.FC<UtilityDamageBasicStepsProps> = ({ formData, setFormData }) => (
  <div className="space-y-4">
    <div>
...
export const UtilityDamageHealthSafetyStep: React.FC<UtilityDamageBasicStepsProps> = ({ formData, setFormData }) => (
  <div className="space-y-4">
    <div>
...
export const UtilityDamageRootCausesStep: React.FC<UtilityDamageBasicStepsProps> = ({ formData, setFormData }) => (
