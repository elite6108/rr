...
export const uploadEnvironmentalFile = async (file: File, autoId: string): Promise<string> => {
...
export const refreshEnvironmentalFileUrls = async (fileUrls: string[]): Promise<string[]> => {
