...
import { uploadEnvironmentalFile } from '../utils/environmentalFileUtils';

export const useEnvironmentalFileUpload = () => {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      for (const file of fileArray) {
        const signedUrl = await uploadEnvironmentalFile(file, autoId);
