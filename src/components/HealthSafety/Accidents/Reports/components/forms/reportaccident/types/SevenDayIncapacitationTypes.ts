// Define the form data structure for Seven Day Incapacitation forms
export interface SevenDayIncapacitationFormData {
...
export interface SevenDayIncapacitationFormProps {
  onClose?: () => void;
  initialData?: any;
  isEditing?: boolean;
}
