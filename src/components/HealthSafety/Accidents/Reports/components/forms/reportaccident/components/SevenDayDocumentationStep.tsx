...
interface SevenDayDocumentationStepProps {
  ...
  handleFileUpload: (files: FileList, fieldName: 'file_urls') => void;
}

export const SevenDayDocumentationStep: React.FC<SevenDayDocumentationStepProps> = ({ 
  formData, 
  setFormData, 
  uploadingFiles, 
  handleFileUpload 
