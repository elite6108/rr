...
interface UnsafeActionsFormProps {
  onClose?: () => void;
  initialData?: any;
  isEditing?: boolean;
}
...
export default function UnsafeActionsForm({ onClose, initialData, isEditing = false }: UnsafeActionsFormProps) {
  ...
  // Update the ID display in the form
  const idField = (
    <div>
