...
interface HospitalTreatmentFormProps {
  onClose?: () => void;
  initialData?: any;
  isEditing?: boolean;
}

export default function HospitalTreatmentForm({ onClose, initialData, isEditing = false }: HospitalTreatmentFormProps) {
  // Generate autoId on load with format HT-XXXXX (where X is a number) or use existing one
  ...
  const [formData, setFormData] = useState<FormData>(() => {
    if (isEditing && initialData) {
      return {
        ...
        reportType: initialData.reportType || 'Hospital Treatment',
  ...
  return (
    <div className="hospital-treatment-form">
      <h1 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Hospital Treatment Report</h1>
      {submitted ? (
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                <p>Your hospital treatment report has been successfully submitted and saved.</p>
              </div>
            </div>
          </div>
        </div>
