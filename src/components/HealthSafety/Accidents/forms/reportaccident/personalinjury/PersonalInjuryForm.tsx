...
export default function PersonalInjuryForm({ onClose, initialData, isEditing = false }: PersonalInjuryFormProps) {
  // Generate autoId on load with format PI-XXXXX (where X is a number) or use existing one
  ...
  const [formData, setFormData] = useState<FormData>(() => {
    if (isEditing && initialData) {
      return {
        ...
        reportType: initialData.reportType || 'Personal Injury',
  ...
  return (
    <div className="personal-injury-form">
      <h1 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Personal Injury Report</h1>
      {submitted ? (
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                <p>Your personal injury report has been successfully {isEditing ? 'updated' : 'submitted'} and saved.</p>
              </div>
            </div>
          </div>
        </div>
