...
interface MinorAccidentFormProps {
  onClose?: () => void;
  initialData?: any;
  isEditing?: boolean;
}
...
export default function MinorAccidentForm({ onClose, initialData, isEditing = false }: MinorAccidentFormProps) {
  // Generate autoId on load with format MA-XXXXX (where X is a number) or use existing one
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 p-6 rounded shadow-lg w-full max-w-md relative">
            ...
            <div className="mb-2">
              ...
              <input type="text" value={actionDraft.title} onChange={e => setActionDraft({ ...actionDraft, title: e.target.value })} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white" />
            </div>
            <div className="mb-2">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Action Due Date *</label>
              <input type="date" value={actionDraft.dueDate} onChange={e => setActionDraft({ ...actionDraft, dueDate: e.target.value })} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white" />
            </div>
            <div className="mb-2">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Action Description *</label>
              <textarea value={actionDraft.description} onChange={e => setActionDraft({ ...actionDraft, description: e.target.value })} rows={3} className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white" />
            </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-green-700 dark:text-green-300">
                <p>Your minor accident report has been successfully submitted and saved.</p>
              </div>
            </div>
          </div>
        </div>
