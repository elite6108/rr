...
export default function NearMissForm({ onClose, initialData, isEditing = false }: NearMissFormProps) {
  // Generate autoId on load with format NM-XXXXX (where X is a number) or use existing one
  ...
  const [formData, setFormData] = useState<FormData>(() => {
    if (isEditing && initialData) {
      ...
      const formDataObject = {
        ...
        reportType: initialData.reportType || initialData.report_type || 'Near Miss',
