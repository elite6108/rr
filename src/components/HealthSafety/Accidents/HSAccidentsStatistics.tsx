      ...
      const addLogoAndTitle = (callback: () => void) => {
        if (companyLogo) {
          ...
          logoImg.onload = () => {
            ...
            ctx.fillText('Accident Statistics Report', titleX, 45);
          ...
          logoImg.onerror = () => {
            ...
            ctx.fillStyle = '#000000';
            ctx.font = 'bold 24px Arial';
            ctx.fillText('Accident Statistics Report', 20, 45);
          ...
          addLogoAndTitle(() => {
            ...
            canvas.toBlob((blob) => {
              if (blob) {
                ...
                link.download = `accidents-statistics-${new Date().toISOString().split('T')[0]}.jpg`;
