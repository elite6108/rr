...
import { Users, ClipboardCheck, Bell, Package } from 'lucide-react';
import SpotlightCard from '../../../../../styles/spotlight/SpotlightCard';
import type { DriverWithStaff } from '../types';

interface VehicleWidgetsProps {
  isDarkMode: boolean;
  drivers: DriverWithStaff[];
  vehicles: any[];
  reminders: any[];
  onDriversClick: () => void;
...
export const VehicleWidgets: React.FC<VehicleWidgetsProps> = ({
  isDarkMode,
  drivers,
  vehicles,
  reminders,
