  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-y-auto h-full w-full flex items-center justify-center z-50">
        <div className="relative bg-white dark:bg-gray-800 rounded-lg shadow-lg-xl p-8 max-w-md w-full m-4">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Upload Health & Safety Policy PDFs</h2>
            <button
              onClick={onClose}
                    ...
                    <div className="flex-1 min-w-0 mr-4">
                      {editingIndex === index ? (
                        ...
                        <div className="flex items-center">
                          <span className="text-sm text-gray-600 dark:text-gray-300 truncate">{file.displayName}</span>
                          <button
                            type="button"
