...
import { RiskAssessmentData, SortConfig, getReviewStatus, getSignatureStatus, handleSort } from '../utils/riskAssessmentUtils';
...
interface RiskAssessmentTableProps {
  ...
  onViewPDF: (assessment: RiskAssessmentData) => void;
  error: string | null;
            ...
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 rounded-lg overflow-hidden">
              <thead className="bg-gray-50 dark:bg-gray-700">
                <tr>
                  <th 
                    ...
                    onClick={() => handleSort('ra_id', sortConfig, setSortConfig)}
                  >
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {riskAssessments.map((assessment) => {
                  const reviewStatus = getReviewStatus(assessment.review_date);
                  return (
                    <tr key={assessment.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        {(() => {
                          const signatureStatus = getSignatureStatus(assessment.last_signed);
                          return (
                            <span className={signatureStatus.className}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${reviewStatus.className}`}>
                          {reviewStatus.text}
                        </span>
                      </td>
