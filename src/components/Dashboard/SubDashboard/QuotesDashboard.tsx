...
import { ArrowRight, FileText, Users, FileCheck, Receipt, ChevronLeft } from 'lucide-react';
...
interface QuotesDashboardProps {
  ...
  onShowQuotesList: () => void;
  onShowLeadManagement: () => void;
  onShowQuoteTerms: () => void;
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <Users className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#6bff90' }} />
            </div>
          </button>
        </SpotlightCard>
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <FileCheck className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#6bff90' }} />
            </div>
          </button>
        </SpotlightCard>
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <Receipt className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#6bff90' }} />
            </div>
          </button>
        </SpotlightCard>
      </div>
