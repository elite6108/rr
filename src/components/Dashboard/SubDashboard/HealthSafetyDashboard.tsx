          ...
          >
            ...
            >
              ...
              <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
                ...
                <Users2 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#FCA5A5' }} />
            </div>
            </button>
          </SpotlightCard>
          ...
          >
            ...
            >
              ...
              <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
                ...
                <Truck className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#FCA5A5' }} />
            </div>
            </button>
          </SpotlightCard>
          ...
          >
            ...
            >
              ...
              <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
                ...
                <Flame className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#FCA5A5' }} />
              </div>
              </button>
          </SpotlightCard>
        </div>
