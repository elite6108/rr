...
import { ArrowRight, Building2, FileText, Wallet, ChevronLeft } from 'lucide-react';
...
interface PurchaseOrdersDashboardProps {
  ...
  onShowSuppliersList: () => void;
  onShowPurchaseOrdersList: () => void;
  totalAmount: number;
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <Building2 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#6b8bff' }} />
            </div>
          </button>
        </SpotlightCard>
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <FileText className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#6b8bff' }} />
            </div>
          </button>
        </SpotlightCard>
        ...
        >
          ...
          <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
            ...
            <Wallet className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#6b8bff' }} />
          </div>
        </SpotlightCard>
      </div>
    </div>
