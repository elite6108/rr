...
interface TrainingDashboardProps {
  onBack: () => void;
  onShowDSEAssessment: () => void;
  onShowTrainingMatrix: () => void;
  totalDSEAssessments: number;
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <FileText className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#4364e8' }} />
            </div>
          </button>
        </SpotlightCard>
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-5 -right-1 w-16 h-16 pointer-events-none">
              ...
              <Users className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8" style={{ color: '#4364e8' }} />
            </div>
          </button>
        </SpotlightCard>
      </div>
