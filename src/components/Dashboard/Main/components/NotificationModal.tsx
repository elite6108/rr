...
export function NotificationModal({ onClose, setNotificationCount }: NotificationModalProps) {
  ...
  return createPortal(
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl mx-4 my-8 relative">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Notifications</h2>
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            View your task assignments, overdue items, and items due soon.
          </p>
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700 rounded-b-lg flex justify-end">
            <button
                onClick={onClose}
